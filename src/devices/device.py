...
class Device:
	...
	def __init__(self, serial = None, fiona_id = None, last_ip = None, last_cookie = None, p12 = None, books = None, anonymous = False):
		self.serial = serial or str(uuid4())
		self.fiona_id = fiona_id or None
		self.last_ip = last_ip
		self.last_cookie = last_cookie
		self.p12 = _PKCS12_NA if anonymous else (p12 or None)
